...
function HomePage() {
  ...
  const trackFormSubmit = (hizmetTuru) => {
    if (window.gtag) {
      window.gtag('event', 'form_gonderimi', {
        'event_category': 'lead',
        'event_label': hizmetTuru, // Hangi hizmet için form doldurulduğunu görebilirsin
        'value': 1
      });
    }
  };
  ...
  const handleFormSubmit = (e) => {
    ...
    // Form başarıyla doğrulanınca Analitik verisini gönder
          ...
          <div className="container">
            <div className="hero-content">
              ...
              <div className="cta-buttons">
                <a href="tel:+905432064055" className="btn btn-primary" onClick={trackHeroCall}>
        ...
        <section className="reviews" id="yorumlar">
          <div className="container">
            ...
            <div className="reviews-carousel-wrapper">
              ...
              >
                {allReviews.map((review, index) => (
                  <div className="reviews-slide" key={index}>
                    <ReviewCard
                      name={review.name}
                      text={review.text}
                      stars={review.stars}
            ...
            <div className="reviews-dots">
              {Array.from({ length: allReviews.length - (visibleCount - 1) }).map((_, i) => (
                <button
                  key={i}
